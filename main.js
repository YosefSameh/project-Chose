...
// requst.open("GET","http://api.aladhan.com/v1/calendarByCity?country=SA&city=Makkah al Mukarramah")
...
//         console.log( posts.data[0].date.gregorian.weekday.en)

//         document.getElementById("h4-1").innerHTML += posts.data[0].timings.Fajr
//         document.getElementById("h4-3").innerHTML += posts.data[0].timings.Dhuhr
//         document.getElementById("h4-2").innerHTML += posts.data[0].timings.Asr
//         document.getElementById("h4-4").innerHTML += posts.data[0].timings.Maghrib
//         document.getElementById("h4-5").innerHTML += posts.data[0].timings.Isha
//         document.getElementById("p").innerHTML += posts.data[0].date.gregorian.weekday.en   
//         document.getElementById("p").innerHTML += posts.data[0].date.readable
...
// new Promise(function (resolv,reget) {
...
// for(post of posts){
    ...
    // h5.classList.add("p-5")
    // document.body.appendChild(div)
    
    // h2.innerHTML+=post.data.timings.Fajr
